...
package com.prachatech.appointment.utils;
...
//                        RequestBody.create(MEDIA_TYPE_PNG, new File(filepath)))
    ...
    public String ObjectuploadImage(String strUrl, String userId,String hospital_id, String sourceImageFile) {

        try {
            File sourceFile = new File(sourceImageFile);


            Log.d(TAG, "File...::::" + sourceFile + " : " + sourceFile.exists()+" size:"+
            sourceFile.length()/(1024*1024)+"mb");
            ...
            Request request = new Request.Builder()
                    ...
                    .post(requestBody)
                    .build();
                      Log.e("requrest ",""+request.toString());
            Log.e("requrest body",""+request.body().toString());
            OkHttpClient client = new OkHttpClient();
            Response response = client.newCall(request).execute();

...
import com.prachatech.appointment.model.Specialist;
import com.prachatech.appointment.model.Specialists;
import com.prachatech.appointment.model.TimeSlot;
   ...
   private void fetchData(int data_type,int position){
        switch (data_type){
            case 1:
                ...
                spl=null;
                spl_txt.setText("Select Specialist");
                specialists=null;
                hospitals=null;
    ...
    private void FetchHospitals(String specialist,String  city) {
        ...
        Call<HospitalList> call= service.getHospitals(object, ApiUrl.context_type);
        showDialog();
    ...
    private void FetchSpecialists(String deptname,String city) {
        ...
        object.addProperty("city",city);
        Call<Specialists> call= service.getSpecialists(object, ApiUrl.context_type);
            ...
            public void onResponse(Call<Specialists> call, Response<Specialists> response) {
                ...
                if(detps!=null)
                {
                    ...
                    if(detps.getStatus()==1)
                    {
                      ...
                      dept=null;
                      dept_txt.setText("No Specialists");
                        showToast(detps.getMessage());
                    }
                }
    ...
    private void FetchDepatments(String city) {
        JsonObject object=new JsonObject();
        object.addProperty("city",city);
        Call<DepartmentList> call= service.getDepts(object, ApiUrl.context_type);
    ...
    private void FeatchCity() {
        Call<CityList> call= service.getCitys(new JsonObject(), ApiUrl.context_type);
        showDialog();
    ...
    private void addAppointmentApi() {
        ...
        Call<RegResult> call= service.addAppointments(appointment, ApiUrl.context_type);
        showDialog();
            ...
            public void onResponse(Call<RegResult> call, Response<RegResult> response) {
                ...
                if(result!=null) {
                    ...
                    if(result.getStatus()==1)
                    {
                     result.getAUId();
                     Log.e("finsh","finsh");
//                     startActivity(new Intent(OpRegistrationActivity.this,StatusActivity.class));
    ...
    private void forward() {
            Intent intent = new Intent(OpRegistrationActivity.this, StatusActivity.class);

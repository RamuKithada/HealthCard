...
public class HeightListAdapter extends RecyclerView.Adapter<HeightListAdapter.ViewHolder>{
    Context context;
ArrayList<Integer> integers;
  int selected=-1;

    public HeightListAdapter(Context context, ArrayList<Integer> integers) {

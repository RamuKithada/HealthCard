...
public class SessionManager {
    ...
    private static final String PREF_NAME = "Scan";
    ...
    public void createLoginSession(String id, String email, String name, String role, boolean is_login) {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_ROLE, pref.getString(KEY_NAME, null));
